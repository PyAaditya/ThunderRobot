...
import ThunderRobot.modules.sql.connection_sql as sql
from ThunderRobot import DEV_USERS, DRAGONS, dispatcher
from ThunderRobot.modules.helper_funcs import chat_status
