...
# from ThunderRobot.modules.sql import warns_sql as warnssql
import ThunderRobot.modules.sql.blacklist_sql as blacklistsql

# from ThunderRobot.modules.sql import cust_filters_sql as filtersql
# import ThunderRobot.modules.sql.welcome_sql as welcsql
import ThunderRobot.modules.sql.locks_sql as locksql
import ThunderRobot.modules.sql.notes_sql as sql

# from ThunderRobot.modules.rules import get_rules
import ThunderRobot.modules.sql.rules_sql as rulessql
from ThunderRobot import EVENT_LOGS, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from ThunderRobot.__main__ import DATA_IMPORT
from ThunderRobot.modules.connection import connected
from ThunderRobot.modules.helper_funcs.alternate import typing_action
from ThunderRobot.modules.helper_funcs.chat_status import user_admin
from ThunderRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("ThunderRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("ThunderRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `ThunderRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("ThunderRobot{}.backup".format(chat_id))  # Cleaning file
