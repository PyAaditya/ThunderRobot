...
import ThunderRobot
import ThunderRobot.modules.sql.welcome_sql as sql
...
from ThunderRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from ThunderRobot.modules.helper_funcs.msg_types import get_welcome_type
from ThunderRobot.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from ThunderRobot.modules.log_channel import loggable
from ThunderRobot.modules.sql.global_bans_sql import is_user_gbanned
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome yourself
                ...
                if not ThunderRobot.ALLOW_CHATS:
