...
import ThunderRobot.modules.sql.global_bans_sql as gban_sql
import ThunderRobot.modules.sql.users_sql as user_sql
from ThunderRobot import DEV_USERS, OWNER_ID, dispatcher
